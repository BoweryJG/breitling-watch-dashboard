...
((SELECT id FROM patients WHERE email = 'robert.anderson@email.com'), (SELECT id FROM services WHERE name = 'Dental Cleaning'), 5, 'Best dental experience I have ever had. Very gentle and thorough.', true, NOW() - INTERVAL '1 week'),
